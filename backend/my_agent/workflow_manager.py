...
class WorkflowManager:
    ...
    def run_workflow(self, patient_prompt: str, thread_id: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Run the workflow
            if thread_id:
                result = self.app.invoke(state, config={"configurable": {"thread_id": thread_id}})
            else:
    ...
    def reset_workflow(self, thread_id: str = None) -> Dict[str, Any]:
        ...
        try:
            if thread_id:
                ...
                return {
                    'success': True,
                    'message': 'All workflow states reset'
                }
        except Exception as e:
            return {
                'success': False,
