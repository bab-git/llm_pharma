...
class TestDashboardDemo:
    ...
    def test_demo_graph_structure(self):
        ...
        try:
            from frontend.demo_graph import create_demo_graph, create_demo_agent_state
            ...
            expected_conditionals = [
                'should_continue_patient', 'should_continue_policy', 'should_continue_trials'
            ]
            
            for conditional in expected_conditionals:
                assert conditional in conditional_functions, f"Conditional {conditional} should be present"
    ...
    def test_dashboard_import(self):
        ...
        try:
            ...
            from frontend.demo_graph import create_demo_graph
            assert create_demo_graph is not None, "create_demo_graph should be importable"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--manual", action="store_true", help="Launch dashboard for manual testing")
