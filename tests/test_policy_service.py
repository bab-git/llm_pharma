...
def test_policy_service():
    ...
    try:
        ...
        print(f"✅ PolicyService instance created")
        ...
        print(f"   ✅ Class method policy search completed")
        ...
        if search_result_class['unchecked_policies']:
            ...
            print(f"   ✅ Class method policy evaluation completed")
        ...
        print(f"✅ PolicyEligibility model works")
