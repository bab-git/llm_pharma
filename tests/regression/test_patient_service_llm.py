...
from backend.my_agent.patient_collector import PatientService, PatientId
        ...
        for i, prompt in enumerate(test_cases, 1):
            ...
            try:
                ...
                if isinstance(patient_id, int) and patient_id > 0:
                    ...
                    print(f"   ⚠️ Unexpected ID format: {patient_id} (type: {type(patient_id)})")
        ...
        for patient_id in test_patient_ids:
            ...
            try:
                ...
                if patient_data is not None:
                    ...
                    print(f"   - Previous Trials: {patient_data.get('previous_trials', 'N/A')}")
                else:
    ...
    try:
        ...
        try:
            ...
            if rewritten_profile and len(rewritten_profile.strip()) > 0:
                print(f"   ✅ Rewritten profile is not empty (length: {len(rewritten_profile)})")
                
                # Check for key information
                if "arthritis" in rewritten_profile.lower():
                    print("   ✅ Rewritten profile mentions arthritis")
                if "38" in rewritten_profile or "38-year-old" in rewritten_profile.lower():
                    print("   ✅ Rewritten profile mentions age")
                if "mental_health" in rewritten_profile.lower() or "cancer" in rewritten_profile.lower() or "leukemia" in rewritten_profile.lower():
    ...
    try:
        ...
        for i, prompt in enumerate(test_prompts, 1):
            ...
            try:
                ...
                print(f"   ✅ Patient Collector Node completed")
                ...
                if patient_data:
                    print(f"   - Patient Data: Found (age: {patient_data.get('age', 'N/A')})")
                else:
                ...
                if profile:
                    ...
                    print(f"   - Patient Profile: Not generated")
    ...
    try:
        ...
        try:
            ...
            if rewritten_profile:
                print(f"   - Rewritten Profile: Generated ({len(rewritten_profile)} chars)")
                ...
                print(f"   - Rewritten Profile: Not generated")
...
def main():
    ...
    if passed == total:
        print("🎉 All tests passed! PatientService is working correctly with LLM calls.")
    else:
